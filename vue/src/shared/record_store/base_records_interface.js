...
export default BaseRecordsInterface = (function() {
  BaseRecordsInterface = class BaseRecordsInterface {
    static initClass() {
      this.prototype.views = [];
      this.prototype.model = 'undefinedModel';
  
      this.prototype.missingIds = [];
      this.prototype.fetchedIds = [];
  
      this.prototype.fetchMissing = debounce(function() {
      ...
      this.prototype.apiEndPoint = null;
    }
    ...
    baseConstructor(recordStore) {
      ...
      return this.remote.onUploadSuccess = data => {
        this.recordStore.importJSON(data);
        return data;
      };
    }
  ...
  BaseRecordsInterface.initClass();
