...
module.exports = {
  ...
  'successfully_edits_group_name_and_description': (test) => {
    ...
    page.fillIn('.group-form__group-description .lmo-textarea', 'Dusty sandles')
    page.click('.group-form__submit-button')
  ...
  'successfully_starts_a_discussion': (test) => {
    ...
    page.fillIn('.discussion-form .lmo-textarea', "I've had the time of my life")
  ...
  //   page.expectValue('.discussion-form .lmo-textarea', "I've had the time of my life" )
  // },
