...
![location of the email address on the group page](email_email_button.png)
...
![Location of the approve and reject buttons for an unrecognised email](email_unreleased_emails.png)
