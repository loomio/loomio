...
The bundled Haraka relay rejects SPF failures before forwarding mail to Loomio. It stamps its own SPF result but does not currently evaluate DKIM or DMARC.
