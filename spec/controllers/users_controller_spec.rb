...
describe UsersController do
  ...
  describe "#upload_new_avatar" do
    before do
      ...
      allow(controller).to receive(:get_notifications)
      @allow(user).to receive(:avatar_kind=).with("uploaded")
      @allow(user).to receive(:uploaded_avatar=).with("www.peter_chilltooth.jpg")
    end
