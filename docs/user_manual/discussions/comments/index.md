...
![Mentioning Samira Patel in a comment](../notifying_people/comment_mention.png)

To notify everyone in the group, type **@**, start typing the group name, then select it from the list.

![Searching for Oatmilk Cooperative while writing a group mention](../notifying_people/mentioning_group_1.png)

![Oatmilk Cooperative selected as a group mention](../notifying_people/mentioning_group_2.png)
...
![Notification history in a comment's actions menu](../notifying_people/comment_notification_history.png)
...
![Notification history for a comment mentioning Samira Patel](../notifying_people/comment_notification_example.png)
