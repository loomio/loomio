angular.module('loomioApp').directive 'newComment', ($rootScope, Session, Records, AbilityService, ReactionService, TranslationService, ModalService, EditCommentForm, RevisionHistoryModal) ->
  scope: {eventable: '='}
  restrict: 'E'
