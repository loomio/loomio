...
class Dev::DiscussionMailerTest < ActionController::TestCase
  ...
  test "discussion_created" do
    ...
    assert_text_no_tags('strong.email-notification-text', "started a discussion")
  ...
  test "discussion_announced" do
    ...
    assert_response :success
    assert_text_no_tags('strong.email-notification-text', "invited you to a discussion")
    assert_text_no_tags('.email-user-content', "A description for this discussion. Should this be rich?")
  end
  ...
  test "new_comment" do
    ...
    assert_response :success
    assert_text_no_tags('strong.email-notification-text', "Jennifer Grey commented in: What star sign are you?")
    assert_text_no_tags('.email-user-content', "hello patrick.")
  end

  test "user_mentioned" do
    get :setup_discussion_mailer_user_mentioned_email
    assert_response :success
    assert_text_no_tags('strong.email-notification-text', "Jennifer Grey mentioned you")
    assert_text_no_tags('.email-user-content', "hey @patrickswayze wanna dance?")
  end

  test "comment_replied_to" do
    get :setup_discussion_mailer_comment_replied_to_email
    assert_response :success
    assert_text_no_tags('strong.email-notification-text', "Patrick Swayze replied to you")
    assert_text_no_tags('.email-user-content', "why, hello there @jennifergrey")
  end
end
