class GroupExportWorker < ApplicationJob
  def perform(group_ids, group_name, requestor_id, recipient_email = nil)
    ...
    UserMailer.group_export_ready(requestor.id, group_name, blob.signed_id, recipient_email).deliver
