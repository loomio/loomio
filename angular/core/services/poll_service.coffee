angular.module('loomioApp').factory 'PollService', ($location, AppConfig, Records, FormService, AttachmentService, PollProposalEditVoteModal, PollPollEditVoteModal, PollYesNoEditVoteModal) ->
