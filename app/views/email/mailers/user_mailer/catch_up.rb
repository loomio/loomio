...
class Views::Email::Mailers::UserMailer::CatchUp < Views::Email::BaseLayout
  ...
  def view_template
    div(class: "everything") do
      ...
      div(class: "toc") do
        render Views::Email::Mailers::UserMailer::CatchUp::Headlines.new(
          groups: @groups,
          discussions_by_group_id: @discussions_by_group_id,
          recipient: @recipient,
          utm_hash: @utm_hash
      ...
      if @discussions_by_group_id.has_key?(nil)
        ...
        @discussions_by_group_id[nil].each do |discussion|
          render Views::Email::Mailers::UserMailer::CatchUp::Discussion.new(
    ...
    render Views::Email::Mailers::UserMailer::UnsubscribeLink.new(recipient: @recipient)
  end
