...
ActiveRecord::Schema.define(version: 20140814022929) do
  ...
  create_table "memberships", force: true do |t|
    ...
    t.boolean  "email_new_discussion_and_proposal_notifications", default: true
    t.datetime "archived_at"
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "new_discussion_and_proposal_notifications_enabled",             default: true,       null: false
  end
