angular.module('loomioApp').controller 'GroupActionsDropdownController', ($scope, $modal, UserAuthService) ->
  ...
  $scope.openLeaveGroupModal = ->
    $modal.open
      templateUrl: 'generated/modules/group_page/group_actions_dropdown/leave_group.html'
  ...
  $scope.openDeactivateGroupModel = ->
    $modal.open
      templateUrl: 'generated/modules/group_page/group_actions_dropdown/deactivate_group.html'
