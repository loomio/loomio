class Ability
  ...
  def initialize(user)
    ...
    can :archive, Comment, user_id: user.id
    ...
    can [:destroy, :close_voting, :open_voting, :edit_outcome, :edit_close_date], Motion, :author_id => user.id
    can [:destroy, :close_voting, :open_voting, :edit_outcome, :edit_close_date], Motion,
