ActiveAdmin.register User do
  ...
  member_action :reactivate, method: :put do
    ReactivateUserWorker.perform_later(params[:id].to_i)
  ...
  show do |user|
    ...
    panel("Delete spam account") do
      [
      div("Delete the user and any groups, discussions, comments, votes they created. It will not groups or discussions they are simply a member of."),
