...
![Invite field expanded to show Samira Patel and Alex Morgan as individual recipients](thread_notification.png)
...
![Searching for Samira Patel in the discussion invite field](thread_notify_user.png)
...
![Adding a guest email address in the discussion invite field](thread_notify_email.png)
...
![Mentioning Samira Patel in a comment about the collection schedule](comment_mention.png)

### Mentioning the group

You can also notify everyone in the group at once, by typing **\@** then typing the group name.

![Searching for Oatmilk Cooperative while writing a group mention](mentioning_group_1.png)
![Oatmilk Cooperative selected as a mention in a comment](mentioning_group_2.png)
...
![Invite people highlighted in the Thread members section](thread_invite_icon.png)
...
![Invite to thread window with a field for names or email addresses](thread_invite.png)
...
![Invite to thread window with guest@cafecircle.example selected and an optional message field](invite_guest.png)
...
![Edit discussion context form with a change summary and Everyone in the thread selected for notification](thread_editcontext.png)

The thread edit comment will appear in the thread.

![Timeline entry showing Jamie Chen's summary of the discussion context change](thread_edit_comment.png)
...
![Seen by 3 and Notified 2 highlighted in the Thread members section](thread_engagement.png)

### Seen by

Click on **Seen by** to see who has seen the discussion and when.

![Seen by window listing Jamie Chen, Alex Morgan, and Samira Patel](thread_seenby.png)
...
![Thread notification history showing Alex Morgan and Samira Patel were invited to vote](thread_notified.png)

Open discussion notification history at any time by clicking **Notified** in the **Thread members** section.

![Notified highlighted in the Thread members section](thread_notification_history.png)

### Comment notification history
Alongside the comment, click on the 3 dots drop-down menu (**⋯**) to find **Notification history**.

![Notification history highlighted in a comment's actions menu](comment_notification_history.png)

Opening the **Notification history** will show if any notifications for the comment have been sent, and when.

Each recipient is marked **Read** or **Unread** when that information is available.

![Comment notification history showing Jamie Chen mentioned Samira Patel](comment_notification_example.png)

### Poll notification history
At the bottom of the poll, click on the 3 dots drop-down menu (**⋯**) to find **Notification history**.

![Notification history highlighted in a proposal's actions menu](poll_notification_history.png)

The poll notification history shows who has been invited to the poll and the date invited.

Each recipient is marked **Read** or **Unread** when that information is available.

![Poll notification history showing Alex Morgan and Samira Patel were invited to vote](poll_notification_example.png)
...
![Email when notified highlighted in the discussion sidebar](thread_interact.png)
