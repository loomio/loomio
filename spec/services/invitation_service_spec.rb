...
describe InvitationService do
  ...
  describe '#resend_ignored' do
    ...
    it 'resends invitations after a specified period' do
      ...
      expect { InvitationService.resend_ignored(send_count: 1, age_in_hours: 24) }.to change { ActionMailer::Base.deliveries.count }.by(1)
    end
    ...
    it 'does not resend accepted invitations' do
      ...
      expect { InvitationService.resend_ignored(send_count: 1, age_in_hours: 24) }.to_not change { ActionMailer::Base.deliveries.count }
    end
