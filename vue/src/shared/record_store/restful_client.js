...
export default RestfulClient = (function() {
  RestfulClient = class RestfulClient {
    static initClass() {
      this.prototype.defaultParams = {};
      this.prototype.currentUpload = null;
      this.prototype.apiPrefix = "/api/v1";
    }
