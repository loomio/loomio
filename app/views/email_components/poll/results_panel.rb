...
class Views::EmailComponents::Poll::ResultsPanel < Views::Base
  ...
  def view_template
      ...
      div(class: "poll-mailer__results-chart poll-mailer-common-results") do
        if @poll.show_results?(voted: my_stance && my_stance.cast_at)
          ...
          if @poll.poll_type == "meeting"
            render Views::EmailComponents::Poll::Results::Meeting.new(poll: @poll, recipient: @current_user)
          else
            render Views::EmailComponents::Poll::Results::Simple.new(poll: @poll, recipient: @current_user)
          end
        else
    ...
    render Views::EmailComponents::Poll::Undecided.new(poll: @poll)
  end
end
