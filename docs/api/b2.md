...
## Discussion and Poll CRUD Coverage

`/api/b2` currently supports creating, showing, and listing discussions and polls. It does not yet provide complete CRUD for discussions or polls: edit, delete, and poll close/reopen actions are not exposed through this API.
