...
class Views::DeliveryMailer::Poll::ResultsPanel < Views::ApplicationMailer::Component
  ...
  def view_template
      ...
      div(class: "poll-mailer__results-chart poll-mailer-common-results") do
        if @poll.show_results?(voted: my_stance && my_stance.cast_at)
          ...
          if @poll.poll_type == "meeting"
            render Views::DeliveryMailer::Poll::Results::Meeting.new(poll: @poll, recipient: @current_user)
          elsif @poll.poll_type == "stv"
            render Views::DeliveryMailer::Poll::Results::Stv.new(poll: @poll, recipient: @current_user)
          else
            render Views::DeliveryMailer::Poll::Results::Simple.new(poll: @poll, recipient: @current_user)
          end
        else
    ...
    render Views::DeliveryMailer::Poll::Undecided.new(poll: @poll)
  end
end
