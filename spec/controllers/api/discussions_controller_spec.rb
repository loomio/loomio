...
describe API::DiscussionsController do
  ...
  describe 'update' do
    ...
    context 'failures' do
      it "responds with an error when there are unpermitted params" do
        ...
        expect { put :update, id: discussion.id, discussion: discussion_params, format: :json }.to raise_error 
      end
  ...
  describe 'create' do
    ...
    context 'failures' do
      it "responds with an error when there are unpermitted params" do
        discussion_params[:dontmindme] = 'wild wooly byte virus'
        expect { post :create, discussion: discussion_params, format: :json }.to raise_error 
      end
