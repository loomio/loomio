Feature: Individual contributions
  ...
  Scenario: Member of manual subscription group does not see payment icon
    Given I am logged in
    And I am a member of a manual subscription group
    And I visit the group page
    Then I should not see the pay what you can icon in the navbar
