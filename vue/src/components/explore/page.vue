...
v-main
  v-container.explore-page.max-width-1024.px-0.px-sm-3
    //- h1.text-headline-small(tabindex="-1" v-t="'explore_page.header'")
    ...
    .explore-page__no-results-found(v-if='noResultsFound' v-t="'common.no_results_found'")
    .explore-page__search-results(v-if='showMessage' v-html="$t(searchResultsMessage, {resultCount: resultsCount, searchTerm: query})")
