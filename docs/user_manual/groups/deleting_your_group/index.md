...
When you delete a group, it is removed from view immediately and will be permanently deleted after 30 days. You and group members immediately lose access to the group. If a mistake was made, contact us within 30 days of deleting your group to request restoration.
...
The warning email includes counts for the group's subgroups, members, discussions, polls and comments. If you need to keep the group or [export its data](/en/user_manual/groups/data_export/), reply within 30 days so access can be restored before deletion.
...
![Confirmation form requiring the Oatmilk Cooperative handle](group_delete_group_confirm.png)

## Group data is permanently deleted after 30 days

After 30 days, all the threads, polls, files and other group content will be permanently deleted. ***This is non-reversible!***
