...
- Do not self-reference or market the agent in branch names, commit messages, PR titles, or PR descriptions. Avoid prefixes or attribution such as `codex/`, `claude/`, `copilot/`, `generated by`, or similar.
