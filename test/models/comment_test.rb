...
class CommentTest < ActiveSupport::TestCase
  ...
  test "removes script tags from html body" do
    comment = Comment.new(discussion: @discussion, author: @user, body_format: "html")
  ...
  test "is_most_recent when comment is the last one" do
    comment = Comment.new(discussion: @discussion, body: "First comment", author: @user)
  ...
  test "is not most_recent when a newer comment exists" do
    ...
    newer = Comment.new(discussion: @discussion, body: "Second comment", author: @user)
  ...
  test "destroy removes reactions" do
    comment = Comment.new(discussion: @discussion, body: "Reacted comment", author: @user)
    CommentService.create(comment: comment, actor: @user)
  ...
  test "mentioned_users returns group member mentioned by username" do
    ...
    comment = Comment.new(discussion: @discussion, body: "@#{member.username}", author: @user)
    CommentService.create(comment: comment, actor: @user)
  ...
  test "mentioned_users does not return member of another group" do
    ...
    comment = Comment.new(discussion: @discussion, body: "@#{another_member.username}", author: @user)
    CommentService.create(comment: comment, actor: @user)
  ...
  test "mentioned_users does not return non-members" do
    ...
    comment = Comment.new(discussion: @discussion, body: "@#{non_member.username}", author: @user)
    CommentService.create(comment: comment, actor: @user)
