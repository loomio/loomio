...
module.exports = env => {
  return {
    ...
    devServer: {
     proxy: {
     '^/(api|dev|login_tokens|theme|fonts|img|join|invitations|system|direct_uploads|rails|slack|oauth|facebook|google|beta|admin|assets|upgrade|pricing|community_applications|417|saml_providers|merge_users|intro|bcorp)': {target: 'http://localhost:3000'},
