...
describe "Events::Position" do
  ...
  it "gives events with a parent_id a pos sequence" do
    ...
    puts "e2 position #{e2.position}, created_event.position_counter #{discussion.created_event.position_counter.value}, sequence_id: #{e2.sequence_id}"
    e3 = Event.create!(kind: "new_comment", parent: discussion.created_event, discussion: discussion, eventable: comment3)
    puts "e3 position #{e3.position}, created_event.position_counter #{discussion.created_event.position_counter.value}, sequence_id: #{e3.sequence_id}"
