...
Notifications with external delivery now treat email and push consistently. Mentions and other directed notifications apply both channel volumes from the same thread, group, or account context. In-app-only notices, including reactions, invitation acceptances, membership-request approvals, and unknown-sender notices, send neither email nor push. The legacy account settings for mention emails and proposal-closing emails have been removed; the Email and Push volume settings now control those deliveries.
