...
test the site out properly. If you create a Incognito Window in chrome
(Cmd + Shift + N) it opens up a new window where you can log in with a
separate account and start testing the site simultaneously with two
different users.
