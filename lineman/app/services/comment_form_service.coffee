angular.module('loomioApp').factory 'CommentFormService', ($modal, Records) ->
  new class CommentFormService
    openEditCommentModal: (comment) ->
      $modal.open
        templateUrl: 'generated/components/thread_page/comment_form/edit_comment.html',
    ...
    openDeleteCommentModal: (comment) ->
      $modal.open
        templateUrl: 'generated/components/thread_page/comment_form/delete_comment.html'
