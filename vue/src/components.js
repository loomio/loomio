export default {
  ...
  PasskeySettings: 'profile/passkey_settings',
  ...
  EditCommentForm: 'topic/edit_comment_form',
  ...
  PollCommonForm: 'poll/common/form',
  ...
  TopicTocNav: 'topic/toc_nav',
  TopicItemHeadline: 'topic_items/headline',
  TopicMembers: 'topic/members',
  TopicActionsPanel: 'topic/actions_panel',
  TopicCurrentPollBanner: 'topic/current_poll_banner',
  TopicPreview: 'topic/preview',
  PinEventForm: 'topic/pin_event_form',
