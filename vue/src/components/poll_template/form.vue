...
.poll-template-form
  ...
  v-number-input.mb-4(
    ...
    template(v-slot:append-inner)
      span.mr-4 %
  .text-body-2.mt-n4.pb-4.font-italic.text-medium-emphasis(v-if="pollTemplate.quorumPct && pollTemplate.pollType == 'proposal'" v-t="'poll_common_form.quorum_tip_vote_share_requirement'")
