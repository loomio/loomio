angular.module('loomioApp').directive 'groupActionsDropdown', ->
  ...
  controller: ($scope, $window, AppConfig, AbilityService, ChangeMembershipVolumeForm, ModalService, EditGroupForm, StartGroupForm, LeaveGroupForm, ArchiveGroupForm, Records, ChoosePlanModal) ->
    console.log "yeah"
