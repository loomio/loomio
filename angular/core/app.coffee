...
angular.module('loomioApp').controller 'ApplicationController', ($scope, $router, KeyEventService, ScrollService, User, AppConfig, ModalService, ChoosePlanModal, AbilityService) ->
