angular.module('loomioApp').factory 'PollService', ($location, AppConfig, Records, PollProposalForm, PollYesNoForm, PollPollForm, PollProposalEditVoteModal, PollPollEditVoteModal, PollYesNoEditVoteModal) ->
