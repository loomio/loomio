module EmailHelper
  ...
  def vote_icon_paths_helper(position)
    case position
    when 'yes'
      "https://loomio-uploads.s3.amazonaws.com/themes/pages_logos/000/000/005/original/hand-yes-18.png?1403064691"
    when 'no'
      "https://loomio-uploads.s3.amazonaws.com/themes/app_logos/000/000/005/original/hand-no-18.png?1403064711"
    when 'block'
      "https://loomio-uploads.s3.amazonaws.com/themes/pages_logos/000/000/004/original/hand-block-18.png?1403064137"
    when 'abstain'
