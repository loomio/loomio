...
git add public/img public/css/app.css public/js/app.js public/js/vendor.js public/fonts && git commit -m "production build commit" && git push loomio-production $BUILD_BRANCH:master -f && rm -r public/img public/css public/js 
git checkout $SOURCE_BRANCH
