...
module.exports = {
  ...
  'lets_you_edit_title_and_context': (test) => {
    ...
    page.fillIn('.discussion-form .lmo-textarea', 'improved description')
  ...
  'does_not_store_cancelled_thread_info': (test) => {
    ...
    page.fillIn('.discussion-form .lmo-textarea', 'rubbish description')
    page.click('.dismiss-modal-button', 500)

    page.click('.action-dock__button--edit_thread')

    page.expectNoText('.discussion-form__title-input input', 'dumb title')
    page.expectNoText('.discussion-form .lmo-textarea', 'rubbish description')
  ...
  'allows_guests_to_comment_and_view_thread_in_dashboard': (test) => {
    ...
    page.fillIn('.comment-form .lmo-textarea', 'I am a guest!')
    page.click('.comment-form__submit-button')
    page.expectFlash('Comment added')
  ...
  'adds_a_comment': (test) => {
    ...
    page.loadPath('setup_discussion')
    page.fillIn('.comment-form .lmo-textarea', 'hi this is my comment')
    page.click('.comment-form__submit-button')
  ...
  'can_add_emojis': (test) => {
    ...
    page.loadPath('setup_discussion')
    page.fillIn('.comment-form .lmo-textarea', 'Here is a heart!')
  ...
  'replies_to_a_comment': (test) => {
    ...
    page.loadPath('setup_discussion')
    page.fillIn('.comment-form .lmo-textarea', 'original comment right heerrr')
    page.click('.comment-form__submit-button')
  ...
  'mentions_a_user': (test) => {
    ...
    page.loadPath('setup_discussion')
    page.fillIn('.comment-form .lmo-textarea', '@jennifer')
  ...
  'edits_a_comment': (test) => {
    ...
    page.loadPath('setup_discussion')
    page.fillIn('.comment-form .lmo-textarea', 'original comment right hur')
    page.click('.comment-form__submit-button')
    page.click('.action-dock__button--edit_comment')
    page.fillIn('.edit-comment-form .lmo-textarea', 'edited comment right thur')
  ...
  'invites_a_user_to_a_discussion': (test) => {
    ...
    page.fillIn('.comment-form .lmo-textarea', 'Hello world!')
    page.click('.comment-form__submit-button')
