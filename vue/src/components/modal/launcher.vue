...
export default
{
  components: {
    ...
    MoveTopicForm: asyncComponent(() => import('@/components/topic/move_topic_form')),
    ...
    TagsMergeModal: asyncComponent(() => import('@/components/tags/merge_modal')),
    TopicTagsDialog: asyncComponent(() => import('@/components/tags/topic_tags_dialog')),
    ...
    PinEventForm: asyncComponent(() => import('@/components/topic/pin_event_form')),
    ...
    TopicMembersList: asyncComponent(() => import('@/components/topic/members_list')),
    SeenByModal: asyncComponent(() => import('@/components/topic/seen_by_modal')),
