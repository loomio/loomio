...
export default {
  ...
  computed: {
    url() {
      ...
      case "slack": return "/docs/en/user_manual/integrations/slack";
      case "discord": return "/docs/en/user_manual/integrations/discord";
      case "microsoft": return "/docs/en/user_manual/integrations/microsoft_teams";
      case "mattermost": return "/docs/en/user_manual/integrations/mattermost";
      case "webex": return "/docs/en/user_manual/integrations";
      }
    }
  }
};
