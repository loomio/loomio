...
class EventTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @group.add_member!(@user_thread_loud).set_volume!(:mute)
    @group.add_member!(@user_thread_normal).set_volume!(:mute)
    @group.add_member!(@user_thread_quiet).set_volume!(:mute)
