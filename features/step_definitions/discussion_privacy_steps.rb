...
When(/^I visit a public group$/) do
  @public_group = FactoryGirl.create :group, visible: true, private_discussions_only: false
...
When(/^I visit a private group$/) do
  @private_group = FactoryGirl.create :group, visible: true, private_discussions_only: true
