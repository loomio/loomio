...
.poll-common-form-fields
  //- poll_common_tool_tip(:poll='poll')
  .md-block
  ...
  v-textarea(lmo-textarea v-model='poll.details', :placeholder="$t('poll_' + poll.pollType + '_form.details_placeholder')", :label="$t('poll_common_form.details')")
