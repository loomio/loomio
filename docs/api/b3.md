...
API keys in query strings are rejected because URLs can be recorded by proxies and access logs. Existing write integrations may temporarily continue sending `b3_api_key` in the request body while migrating to the bearer header.
