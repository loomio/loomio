class AddTopicIdAndTagsToPgSearchDocuments < ActiveRecord::Migration[8.0]
  ...
  def down
    ...
    remove_index :pg_search_documents, :tags, if_exists: true
    remove_index :pg_search_documents, :topic_id, if_exists: true
    remove_column :pg_search_documents, :tags, if_exists: true
    remove_column :pg_search_documents, :topic_id, if_exists: true
  end
