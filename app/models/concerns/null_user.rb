module NullUser
  ...
  NIL_METHODS   = [:key, :username, :avatar_url, :selected_locale, :deactivated_at, :time_zone, :time_zone_city, :default_membership_volume, :unsubscribe_token, :presence, :facebook_community]
