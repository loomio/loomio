...
ActiveRecord::Schema.define(:version => 20131029013350) do
  ...
  create_table "events", :force => true do |t|
    ...
    t.integer  "user_id"
    t.integer  "discussion_id"
    t.integer  "discussion_item_number"
  end

  add_index "events", ["created_at"], :name => "index_events_on_created_at"
  add_index "events", ["discussion_id", "discussion_item_number"], :name => "index_events_on_discussion_id_and_discussion_item_number", :unique => true
