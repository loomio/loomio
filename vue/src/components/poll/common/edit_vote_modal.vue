  ...
  div(v-if="isEditing")
    v-card-text
      v-layout.mb-3(align-center wrap)
        poll-common-directive(:size="48" :stance-choice="choice" :poll="stance.poll()" name="stance-choice", v-if="choice.id && choice.score > 0", v-for="choice in orderedStanceChoices" :key="choice.id")
