...
ActiveRecord::Schema.define(:version => 20140101034220) do
  ...
  create_table "email_integrations", :force => true do |t|
  ...
  add_index "email_integrations", ["token"], :name => "index_email_integrations_on_token"
