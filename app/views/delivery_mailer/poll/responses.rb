...
class Views::DeliveryMailer::Poll::Responses < Views::ApplicationMailer::Component
        ...
        poll.stances.latest.with_reason.each do |stance|
          tr do
            td(valign: "top", style: "width: 36px; height: 36px") do
              render Views::DeliveryMailer::Common::Avatar.new(user: stance.participant)
            end
            td(class: "poll-mailer-common-responses__reason pl-2") do
              table do
                tr do
                  ...
                  td(valign: "top") do
                    render Views::DeliveryMailer::Poll::StanceChoices.new(
                      poll: poll,
                      stance: stance,
                      recipient: @recipient
                    )
