...
v-card
  ...
  v-card-text
    ...
    v-btn(:href="baseUrl + 'g/' + group.key + '/export.csv'" target="_blank" v-t="'group_page.options.export_data_as_csv'")
    h4.my-4(v-t="'export_data_modal.as_html'")
    v-btn(:href="baseUrl + 'g/' + group.key + '/export.html'" target="_blank" v-t="'group_page.options.export_data_as_html'")
