...
1. Edit `.env` and set the image tag:
   ...
   ```sh
   LOOMIO_CONTAINER_TAG=3.1.2
   ```

   Use `3.1.2` to pin this exact release, or `3.1` to track the 3.1 patch series and pick up future 3.1.x releases automatically on each update.
