...
class Views::DeliveryMailer::Poll::Vote < Views::ApplicationMailer::Component
  ...
  def view_template
    ...
    div(class: "poll-mailer__vote pb-4") do
      ...
      if stance.cast_at
        ...
        render Views::DeliveryMailer::Poll::Stance.new(stance: stance, recipient: @recipient)
      elsif @poll.active?
        ...
        @poll.poll_options.each do |option|
          render Views::DeliveryMailer::Poll::PollOption.new(
            poll: @poll,
            poll_option: option,
            stance: stance,
            recipient: @recipient
