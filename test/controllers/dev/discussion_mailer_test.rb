...
class Dev::DiscussionMailerTest < ActionController::TestCase
  ...
  test "discussion_created" do
    ...
    assert_text_no_tags('.topic-mailer__body', "A description for this discussion. Should this be rich?")
  end
  ...
  test "new_comment" do
    ...
    assert_text_no_tags('.topic-mailer__body', "hello patrick.")
  end
  ...
  test "user_mentioned" do
    ...
    assert_text_no_tags('.topic-mailer__body', "hey @patrickswayze wanna dance?")
  end
  ...
  test "comment_replied_to" do
    ...
    assert_text_no_tags('.topic-mailer__body', "why, hello there @jennifergrey")
  end
end
