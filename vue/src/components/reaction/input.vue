...
v-menu.reactions-input(:close-on-content-click="true")
  template(v-slot:activator="{ props }")
    v-btn.mr-1.emoji-picker__toggle.action-button(icon :size="size" v-bind="props" :color="color" :variant="variant")
      common-icon(:size="size" name="mdi-emoticon-outline" :color="color")
