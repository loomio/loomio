...
module Loomio
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(ie8.js active_admin.css active_admin.js active_admin/print.css marketing.js marketing.css campaigns.js third_party.css unstructured.css wall.css email.css)
