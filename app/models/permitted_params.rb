class PermittedParams < Struct.new(:params)
  ...
  def poll_attributes
    [:title, :details, :poll_type, :discussion_id, :closing_at, :make_announcement, :poll_options_attributes, {poll_options_attributes: [:id, :name, :priority, :_destroy]}]
  end

  def stance_attributes
    [:poll_id, :poll_option_id, :reason, :score]
  end
