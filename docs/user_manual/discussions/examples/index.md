...
![A thread where Oatmilk Cooperative members propose agenda items for their September production meeting.](meeting_focus_2.png#width-90)
...
![Meeting minutes followed by a proposal to approve the recorded decisions and actions.](meeting_minutes.png#width-90)
...
![A thread introducing a reusable packaging policy and gathering requirements from members.](document_introduce.png#width-90)
...
![A first policy draft with a sense check asking whether it is on the right track.](document_integrate.png#width-90)
...
![A completed reusable packaging policy followed by a proposal to approve it.](document_approval.png#width-90)

**Outcome**

When the poll closes, state an outcome.

![The recorded outcome stating that the reusable packaging policy was approved for the trial.](document_outcome.png#width-90)
...
![A thread raising the need to choose a bottle washing supplier, with members offering next steps.](thread_raise_issue.png#width-90)
