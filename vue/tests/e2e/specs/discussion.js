...
module.exports = {
  ...
  'mentions_a_user_in_wysiwyg': (test) => {
    ...
    page.expectElement('.suggestion-list [data-mention-handle="shoes"]')
    page.click('.suggestion-list [data-mention-handle="shoes"]')
    ...
    page.expectElement('.suggestion-list [data-mention-handle="patrickswayze"]')
    page.click('.suggestion-list [data-mention-handle="patrickswayze"]')
    ...
    page.expectText('.suggestion-list', 'Jennifer Grey')
    page.expectElement('.suggestion-list [data-mention-handle="jennifergrey"]')
    page.click('.suggestion-list [data-mention-handle="jennifergrey"]')
    page.pause(200)
    page.click('.comment-form__submit-button')
